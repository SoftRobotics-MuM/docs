...
| **Processing Time [min]** | **Bearbeitungszeit [min]** | 10 | 15 | 20 | 12|
| **Curing Time [h]** | **Aushärtezeit [h]** | 1 | 1.5 | 3.5 | 2.5|
...
The higher the Shore hardness, the harder the silicone.
...
### Assemble the mold
These steps are robot specific. For detailed instructions on **preparing the molds** see the corresponding `Manufacturing Instructions` in the [cloud](https://cloud.tuhh.de/index.php/apps/files/files/223639070?dir=/SoftRobotics-MuM/CAD_Source/20_Robots).
...
## Remove the mold
These steps are robot specific. For detailed instructions on **removing the molds** see the corresponding `Manufacturing Instructions` in the [cloud](https://cloud.tuhh.de/index.php/apps/files/files/223639070?dir=/SoftRobotics-MuM/CAD_Source/20_Robots).
